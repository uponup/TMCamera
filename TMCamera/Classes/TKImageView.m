...
- (void)setShowLine:(BOOL)showLine {
    _showLine = showLine;
    self.showCrossLines = _showLine;
    self.showMidLines = _showLine;
    self.topLeftCorner.hidden = !_showLine;
    self.topRightCorner.hidden = !showLine;
    self.bottomLeftCorner.hidden = !showLine;
    self.bottomRightCorner.hidden = !showLine;
}
